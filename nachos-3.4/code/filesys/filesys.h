...
class FileSystem // la 1 OpenFile mang 2 chieu: 10luong file, moi luong co 1 idFile tuong ung voi type: 0<read&write>,1<only read>,2<stdin>,3<stdout>
{
  public:
	//Khai bao 2 bien 
	...
	//Ham tim slot trong: luong 0,1 chua stdin, stdout nen bo qua
	int FindFreeSlot()
	{
		for(int i = 2; i < 10; i++)
		{
